                        ...
                        <table class="table table-nowrap m-0">
                            ...
                            <tr>
                                <td>
                                    <div class="media align-items-center">
                                        <a href="instructor-course-edit.html" class="avatar avatar-4by3 avatar-sm mr-3">
                                            <img src="{{asset('assets/images/github.png')}}" alt="course" class="avatar-img rounded">
                                        </a>
                                        <div class="media-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="media">
                            <div class="media-left">
                                <a href="#" class="avatar avatar-sm">
                                    <img src="{{asset('assets/images/people/110/guy-9.jpg')}}" alt="Guy" class="avatar-img rounded-circle">
                                </a>
                            </div>
                        ...
                        <div class="media ml-sm-32pt mt-3 border rounded p-3 bg-light">
                            <div class="media-left">
                                <a href="#" class="avatar avatar-sm">
                                    <img src="{{asset('assets/images/people/110/guy-6.jpg')}}" alt="Guy" class="avatar-img rounded-circle">
                                </a>
                            </div>
                            <div class="media-body">
                                <div class="d-flex align-items-center">
