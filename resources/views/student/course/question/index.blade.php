    ...
    <div class="container-fluid page__container">
        ...
        @if(count($questions)<=0)
            <div class="alert alert-light alert-dismissible border-1 border-left-3 border-left-warning" role="alert">
                ...
                <div class="text-black-70">Ohh no! No questions to display.</div>
            </div>
                                    ...
                                    <div class="flex" style="min-width: 200px;">
                                        ...
                                        <div class="d-flex align-items-end">
                                            ...
                                            <div class="text-center">
                                                <a href="{{ route('student.assignment.question.answer_form',['cid'=>$course->cid,'assignment_id'=>$assignment->id,'question_id'=>$question->id]) }}" class="btn btn-sm btn-success" >Answer</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
