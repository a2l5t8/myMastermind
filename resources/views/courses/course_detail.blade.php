    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p><a href="{{ route('assignment.add_form',['cid'=>$course->cid]) }}" class="btn btn-primary">Add Assignment <i class="material-icons">add</i></a></p>
                                ...
                                <div class="nestable-content">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-right">
                                            <a href="{{ route('assignment.questions',['cid'=>$course->cid,'assignment_id'=>$assignment->id]) }}" class="btn btn-outline-primary btn-sm">enter</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
